...
export function NpmIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 256 256" className={className} aria-hidden="true" {...props}>
      <rect width="256" height="256" rx="32" fill="#CB3837" />
      <rect x="48" y="48" width="160" height="160" fill="white" />
      <rect x="80" y="80" width="32" height="96" fill="#CB3837" />
      <rect x="144" y="80" width="32" height="64" fill="#CB3837" />
      <rect x="80" y="80" width="128" height="32" fill="#CB3837" />
    </svg>
  );
}

export function PnpmIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 256 256" className={className} aria-hidden="true" {...props}>
      <rect x="158" y="2" width="96" height="96" rx="12" fill="#F9AD00" />
      <rect x="158" y="110" width="96" height="96" rx="12" fill="#F9AD00" />
      <rect x="50" y="110" width="96" height="96" rx="12" fill="#4E4E4E" />
      <rect x="2" y="110" width="36" height="96" rx="12" fill="#4E4E4E" />
      <rect x="2" y="2" width="96" height="96" rx="12" fill="#4E4E4E" />
      <rect x="110" y="2" width="36" height="96" rx="12" fill="#4E4E4E" />
    </svg>
  );
}

export function BunIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 80 70" className={className} aria-hidden="true" {...props}>
...
export function YarnIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 518 518" className={className} aria-hidden="true" {...props}>
      <path
        fill="#2C8EBB"
...
export function NpxIcon({ className, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 256 256" className={className} aria-hidden="true" {...props}>
      <rect width="256" height="256" rx="32" fill="#CB3837" />
      <rect x="48" y="48" width="160" height="160" fill="white" />
      ...
      <rect x="144" y="80" width="32" height="64" fill="#CB3837" />
      <rect x="80" y="80" width="128" height="32" fill="#CB3837" />
      <circle cx="196" cy="196" r="40" fill="#CB3837" stroke="white" strokeWidth="6" />
      <path
        d="M183 196 L196 183 L209 196 M196 183 L196 213"
        stroke="white"
        strokeWidth="5"
        strokeLinecap="round"
